...
export default class ServicosArmazenagemValueHelp {

	public static open(id: string, view: View): Promise<ServicoArmazenagem>{
		return new Promise(resolve => {
			...
			dlg.attachConfirm((ev: TableSelectDialog$ConfirmEvent) => {
				...
				resolve(ctx.getObject() as ServicoArmazenagem);
			});
