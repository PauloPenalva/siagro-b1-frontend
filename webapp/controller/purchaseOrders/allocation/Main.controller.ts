...
/**
 * @namespace siagrob1.controller.purchaseOrders.allocation
 */
  ...
  async onAlocate() {
    ...
    if (context) {
      this.purchaseContractsAvaiableDialog ??= 
        await DialogHelper.createDialog(this, "siagrob1.view.purchaseOrders.allocation.fragments.PurchaseContractsAvaiables");
